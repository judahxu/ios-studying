...
- (void)viewDidLoad
{
    ...
    imageView.highlightedImage = [UIImage imageNamed:@"1"]; //系统默认读取的是png图片，如果不是的就要写上后缀名
    
    // 按UIImageView自有的初始化方法初始化，可以同时制定高亮的和不高亮的图片，需要用高亮状态控制
    UIImageView *imageView2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"2"] highlightedImage:[UIImage imageNamed:@"2"]];
    ...
    imageView4.image = [UIImage imageNamed:@"10.jpg"];
    ...
    imageView5.image = [UIImage imageNamed:@"10.jpg"];
    ...
    imageView6.image = [UIImage imageNamed:@"10.jpg"];
