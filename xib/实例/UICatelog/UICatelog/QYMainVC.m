...
- (void)viewDidLoad
{
    ...
    [self.menulists addObject:@{kTitleKey:@"Pickers",
                                ...
                                kVCKey:@"QYPickerVC"}];
    [self.menulists addObject:@{ kTitleKey:@"Controls",
                                kSubTitleKey:@"Various uses of UIControl",
                                kVCKey:@"QYControlsViewController"
                                }];
    [self.menulists addObject:@{ kTitleKey:@"TextFields",
                                kSubTitleKey:@"Various uses of UITextField",
                                kVCKey:@"QYTextFieldViewController"
                                }];
    [self.menulists addObject:@{ kTitleKey:@"Images",
                                kSubTitleKey:@"Use of UIImageView",
                                kVCKey:@"QYImageViewController"
                                }];
