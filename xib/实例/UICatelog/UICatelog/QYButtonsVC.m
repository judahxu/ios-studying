...
- (UIButton *)grayBtn
{
    if (_grayBtn == nil) {
        ...
        UIImage *newBgImg = [bgImg resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10) resizingMode:UIImageResizingModeTile];
        [_grayBtn setBackgroundImage:newBgImg forState:UIControlStateNormal];
        
        UIImage *hlImg = [UIImage imageNamed:@"blueButton"];
        UIImage *newHlImg = [hlImg resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10) resizingMode:UIImageResizingModeTile];
...
- (UIButton *)attrBtn
{
    if (_attrBtn == nil) {
        ...
        [hlAttrStr addAttribute:NSBackgroundColorAttributeName value:[UIColor greenColor] range:NSMakeRange(0, hlAttrStr.length)];
...
- (UIButton *)imageButton
{
    if (_imageButton == nil) {
        // 创建_imageButton
        _imageButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 5,100,40)];
...
- (UIButton *)detailDisclosureButton
{
    if (_detailDisclosureButton == nil) {
        ...
        _detailDisclosureButton.tag = kBtnTag;
    }
