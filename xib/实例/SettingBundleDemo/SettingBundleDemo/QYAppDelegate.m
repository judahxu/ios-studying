...
- (void)registerDefaults
{
    ...
    NSString *filePath = [settingPath stringByAppendingPathComponent:@"Root.plist"];
    ...
    for (NSDictionary *tmpDict in preferences) {
        NSString *key = tmpDict[@"Key"];
        NSString *value = tmpDict[@"DefaultValue"];
    ...
    // 将该setting bundle中的配置信息注册到NSRegistrationDomain中，是volatile的
